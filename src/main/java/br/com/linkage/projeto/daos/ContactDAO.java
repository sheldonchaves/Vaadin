package br.com.linkage.projeto.daos;
...
import br.com.linkage.projeto.models.Contact;
...
public class ContactDAO {
    ...
    public static ContactDAO createDemoService() {
        if (instance == null) {

            final ContactDAO contactService = new ContactDAO();
    ...
    public synchronized List<Contact> findAll(String stringFilter) {
        ...
        for (Contact contact : contacts.values()) {
            try {
                ...
                Logger.getLogger(ContactDAO.class.getName()).log(
